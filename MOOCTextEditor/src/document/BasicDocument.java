...
public class BasicDocument extends Document {
	...
	public int getNumWords() {
		...
		// this was just to test that the bench marking was working correctly
		/*
		 * for(int i=0;i<10000;i++){ int a =1; int b =2; int c = a+b; if
		 * (c>1000) break; };
		 */
		List<String> tokens = getTokens("[a-zA-Z]+");
		return tokens.size();
	...
	public static void main(String[] args) {
		...
		testCase(new BasicDocument("sentence, with, lots, of, commas.!  (And some poaren)).  The output is: 7.5."), 15,
				11, 4);
